...
def gerar_relatorio(event, context):
    ...
    json_object = s3.get_object(Bucket='devops-luxor', SSECustomerAlgorithm='AES256', SSECustomerKey='amazon-inspector-devops-reports', Key='amazon-inspector/2023_05___05-05-2023-14-52-13/6bc8a3e8-0277-4ccf-a2f3-19957b6fa734.json')
