...
def gerar_relatorio(event, context):
    ...
    json_object = s3.get_object(Bucket='devops-luxor', ServerSideEncryption='AES256', Key='amazon-inspector/2023_05___05-05-2023-23-48-55/c7974469-dd40-4c19-8aae-ea296eb3093d.json')
